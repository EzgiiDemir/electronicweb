        ...
        <div className="row">
          ...
          backgroundSize: "35%",
              ...
              <div className="banner-content p-5">
                <div className="categories text-primary fs-3 fw-bold">Up to 20% Off</div>
                <h3 className="banner-title">Robotic Course</h3>
                <p>Early bird discount for Robotic coding course</p>
                <a href='/register' className="btn btn-dark text-uppercase">Register Now</a>
              </div>
            </div>
          </div>
          <div className="col-md-6">
            <div className="banner-vlad bg-info" style={{ background: `url(${adImgae4}) no-repeat right bottom`, backgroundSize: "45%" }}>
              <div className="banner-content p-5">
                ...
                <Link to="/shop" className="btn btn-dark text-uppercase">Get Discount</Link>
              </div>
            </div>
          </div>
        </div>
