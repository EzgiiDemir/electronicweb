    ...
    <div className="col">
      <div className="product-item">
        ...
        <div className="d-flex align-items-center justify-content-between">
          ...
          <button type="button" className="rfces text-white" onClick={handleAddtoCart}>
  ...
  const displayedProducts = filteredProducts
    .filter(
      (item) =>
        ...
        (!selectedBrand ||
          (item.brands && item.brands.includes(selectedBrand))) &&
        (!selectedPriceRange ||
            ...
            <div className="filter-shop d-flex justify-content-between">
              <div className="showing-product">
                <p>
                  ...
                  {endIndex > totalProducts ? totalProducts : endIndex} of{" "}
