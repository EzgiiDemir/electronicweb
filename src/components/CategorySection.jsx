          ...
          <div className="col-md-12">
            <div className="category-carousel swiper">
              <div className="swiper-wrapper" style={{gap : '10px', width: '100%'}}>
                <a href="/shop" className="nav-link category-item swiper-slide" style={{width: "237px"}}>
                  <SiArduino style={{width: "8rem"}}/>
                  <h3 className="category-title">Store</h3>
                </a>
                <a href="/shop" className="nav-link category-item swiper-slide" style={{width: "237px"}}>
                  <img src={bread} alt="Category Icon" />
                  <h3 className="category-title">Arduino</h3>
                </a>
                <a href="/shop/motor-motor-controllers" className="nav-link category-item swiper-slide" style={{width: "237px"}}>
                  <img src={bread} alt="Category Icon" />
                  <h3 className="category-title">Motors</h3>
                </a>
                <a href="/shop/hand-tools" className="nav-link category-item swiper-slide" style={{width: "237px"}}>
                  <img src={bread} alt="Category Icon" />
                  <h3 className="category-title">Handtools</h3>
                </a>
                <a href="/shop/microcontrollers" className="nav-link category-item swiper-slide" style={{width: "237px"}}>
                  <img src={bread} alt="Category Icon" />
                  <h3 className="category-title">Microcontrollers</h3>
                </a>
                <a href="/shop/raspberry" className="nav-link category-item swiper-slide" style={{width: "237px"}}>
                  <img src={bread} alt="Category Icon" />
