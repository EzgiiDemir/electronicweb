              ...
              <div className="col-md-6 p-5">
                <div className="section-header">
                  <h2 className="section-title display-4">
                    Get <span className="text-primary">20% Discount</span> on
                    your first purchase
                  </h2>
                </div>
                <p>
                  Subscribe to our news letter and get a 20% coupon and be notified for all up coming events and campain
                </p>
              </div>
              <div className="col-md-6 p-5">
